...
public class TestMRUDP {
    ...
    public static void main(String[] args) throws Exception{
        ...
        serverLooper = new ServerLooper(port, new ByteConnectionProcessor() {
            @Override
            public Response<byte[]> acceptConnection(final ByteSocket socket, byte[] userData) {
                ...
                serverLooper.addLooper(
                        new Looper(socket, new ByteSocketProcessor() {
                            @Override
        ...
        clientLooper = new Looper(client, new ByteSocketProcessor() {
        ...
        client.addPingListener(new BytePingListener() {
            @Override
            public void onPingChange(ByteSocket socket, float ping) {
        ...
        client.addDcListener(new ByteDCListener() {
            @Override
            public void socketClosed(ByteSocket socket, String msg) {
